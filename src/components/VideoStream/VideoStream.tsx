...
const VideoStream = () => {
    ...
    const updateProgress = (text: string) => {
        if (preparationPhase) {
            ...
            console.log(
                "Currently seen ingredients:",
                currentlySeenIngredients
            );
            ...
            setIngredients((prev) =>
                prev.map((item) => {
                    ...
                    const isCurrentlySeen = currentlySeenIngredients.some(
                        (seen) => {
                            const seenLower = seen.toLowerCase();
                            const [itemQuantity, ...itemWords] =
                                itemText.split(" ");
                            const [seenQuantity, ...seenWords] =
                                seenLower.split(" ");
    ...
    const analyzeStream = async () => {
        ...
        try {
            ...
            if (image) {
                ...
                console.log(
                    `Current ${
                        preparationPhase ? "ingredient" : "step"
                    } history:`,
                    formattedHistory
                );
    ...
    return (
        <Box
            sx={{
                minHeight: "100vh",
                width: "100%",
                backgroundColor: preparationPhase
                    ? colors.greenBg
                    : colors.orangeBg,
        ...
        >
            ...
            <Box
                ...
                sx={{
                    ...
                    backgroundColor: preparationPhase
                        ? colors.greenBg
                        : colors.orangeBg, // Match background
                    ...
                    {!started ? (
                        <>
                            ...
                            >
                                ...
                                >
                                    Your AI-powered kitchen companion that helps
                                    you create perfect recipes step by step
                                </Typography>
                                <motion.div
                                    variants={scaleIn}
                                ...
                                {[
                                    {
                                        ...
                                        description:
                                            "Get step-by-step instructions as you cook",
                                    },
                                    {
                                        title: "Ingredient Detection",
                                        description:
                                            "Automatically tracks your ingredients",
                                    },
                                    {
                                        title: "Progress Tracking",
                                        description:
                                            "Monitor your recipe completion",
                                    },
                                ].map((feature, index) => (
                                    <motion.div
                                        key={index}

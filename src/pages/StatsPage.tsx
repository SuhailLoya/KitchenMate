...
function StatsPage() {
  ...
  const handleShare = (completion: RecipeCompletion) => {
    const shareText = `Just completed a cake recipe in ${formatTime(completion.total_time)} with ${completion.completion_rate}% completion rate! 🎂✨`;
                  ...
                  >
                    <CardContent sx={{ p: 3 }}>
                      <Box sx={{ mb: 3 }}>
                        ...
                        >
                          Completed on {new Date(completion.end_time).toLocaleDateString()}
                        </Typography>
                        <Typography 
                          variant="subtitle2"
                          sx={{ 
                        ...
                        >
                          at {new Date(completion.end_time).toLocaleTimeString()}
                        </Typography>
                      </Box>
                      ...
                      <Box sx={{ display: 'grid', gap: 3, gridTemplateColumns: '1fr 1fr', mb: 3 }}>
                        <Box>
                          ...
                          >
                            {formatTime(completion.total_time)}
                          </Typography>
                        </Box>
                        ...
                        <Box>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            ...
                            >
                              {Math.round(completion.completion_rate)}%
                            </Typography>
                          </Box>
                        </Box>
                      </Box>
                      ...
                      <Box sx={{ mb: 3 }}>
                        <Typography sx={{ color: colors.grayDark, mb: 1 }}>
                          Aesthetics Score
                        </Typography>
                        <Rating 
                          value={completion.aesthetics_score / 20}
                          readOnly 
                          precision={0.5}
                          sx={{
                      ...
                      <Divider sx={{ borderColor: colors.grayLight, my: 3 }} />
                      ...
                      >
                        <Tooltip title="Copy link">
                          <IconButton 
                            onClick={() => handleCopyLink(completion)}
                            sx={{ 
                              color: colors.grayDark,
                      ...
                      {completion.final_image_url && (
                        <>
                          <Box sx={{ 
                            ...
                            <img 
                              src={completion.final_image_url} 
                              alt="Final result"
                              style={{
                                width: '100%',
                                height: '200px',
                          ...
                          >
                            ...
                            >
                              Liked by <strong>{likes[0].alt}</strong>
                              {likes.length > 1 && (
